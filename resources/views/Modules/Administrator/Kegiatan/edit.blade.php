        ...
        <div class="row m-1">
            <div class="col-12 ">
                ...
                <ul class="app-line-breadcrumbs mb-3">
                    ...
                    <li class="active">
                        <a class="f-s-14 f-w-500" href="{{ route('admin.master.Kegiatan.index') }}">Kegiatana</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="editFormKegiatan" class="row g-3 app-form rounded-control"
                            action="{{ route('admin.master.Kegiatan.update', $data['kegiatan']->id) }}" method="POST"
                            ...
                            <div class="col-12">
                                ...
                                <a class="btn btn-danger b-r-22" href="{{ route('admin.master.Kegiatan.index') }}">Cancel
                                </a>
                            </div>
                        </form>
                    </div>
