                ...
                <ul class="app-line-breadcrumbs mb-3">
                    <li class="">
                        <a href="#" class="f-s-14 f-w-500">
                            <span>
                                <i class="ph-duotone  ph-table f-s-16"></i> Kerjasama
                            </span>
                        </a>
                    </li>
                    <li class="active">
                        <a href="{{ route('uppsfaculty.MouMoa.index') }}" class="f-s-14 f-w-500">Data</a>
                    </li>
                </ul>
            </div>
        </div>
                            ...
                            <div class="collapse collapse-horizontal" id="collapseFilter">
                                <div class="card card-body dashed-1-secondary w-900">
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <form action="{{ route('uppsfaculty.MouMoa.index') }}" method="GET"
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <form class="row g-3 app-form rounded-control"
                                                    action="{{ route('uppsfaculty.MouMoa.store') }}" method="POST"
                                    ...
                                    @foreach ($data['moumoa'] as $mouMoa)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('uppsfaculty.MouMoa.edit', $mouMoa->id) }}"
                                                    class="btn btn-light-success icon-btn b-r-4">
                                                    <i class="ti ti-edit text-success"></i>
                                                </a>
                                                <form class="btn btn-light-danger icon-btn b-r-4"
                                                    action="{{ route('uppsfaculty.MouMoa.destroy', $mouMoa->id) }}"
                                                    method="POST">
                                                    @method('delete')
                                                    @csrf
                                                    <button type="button"
