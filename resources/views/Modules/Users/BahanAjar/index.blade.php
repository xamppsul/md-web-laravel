                ...
                <ul class="app-line-breadcrumbs mb-3">
                    <li class="">
                        <a href="#" class="f-s-14 f-w-500">
                            <span>
                                <i class="ph-duotone  ph-table f-s-16"></i> Pendidikan
                            </span>
                        </a>
                    </li>
                    <li class="active">
                                                ...
                                                <form action="{{ route('staffdosen.BahanAjar.index') }}" method="GET"
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <button class="btn btn-warning b-r-22"
                                                            onclick="clearfilterFormBahanAjar()" value="Clear">Clear
                                                        </button>
                                                    </div>
                                                </form>
                                            </div>
                ...
                <div class="modal-dialog app_modal_sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p><i class="ti ti-arrow-big-right text-secondary f-w-600"></i> Semester:
                                {{ $BahanAjar->semester }} </p>
...
@section('script')
    ...
    <script type="text/javascript">
        function clearfilterFormBahanAjar() {
