        ...
        <div class="row m-1">
            <div class="col-12 ">
                ...
                <ul class="app-line-breadcrumbs mb-3">
                    ...
                    <li class="active">
                        <a class="f-s-14 f-w-500" href="{{ route('uppsfaculty.Asset.index') }}">Aset</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="editFormAset" class="row g-3 app-form rounded-control"
                            action="{{ route('uppsfaculty.Asset.update', $data['aset']->id) }}" method="POST">
                            @method('put')
                            @csrf
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                <a class="btn btn-danger b-r-22" href="{{ route('uppsfaculty.Asset.index') }}">Cancel
                                </a>
                            </div>
                        </form>
                    </div>
