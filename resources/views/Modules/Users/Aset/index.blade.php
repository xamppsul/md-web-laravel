                ...
                <ul class="app-line-breadcrumbs mb-3">
                    <li class="">
                        <a href="#" class="f-s-14 f-w-500">
                            <span>
                                <i class="ph-duotone  ph-table f-s-16"></i> Aset
                            </span>
                        </a>
                    </li>
                    <li class="active">
                        <a href="{{ route('uppsfaculty.Asset.index') }}" class="f-s-14 f-w-500">Data</a>
                    </li>
                </ul>
            </div>
        </div>
                            ...
                            <div class="collapse collapse-horizontal" id="collapseFilter">
                                <div class="card card-body dashed-1-secondary w-900">
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <form action="{{ route('uppsfaculty.Asset.index') }}" method="GET"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select class="form-select" aria-label="Select kondisi aset"
                                                            name="aset_kondisi" required>
                                                            <option selected="">Pilih Kondisi Aset</option>
                                                            <option value="1"
                                                                {{ request('aset_kondisi') == '1' ? 'selected' : '' }}>Baik
                                                            </option>
                                                            <option value="2"
                                                                {{ request('aset_kondisi') == '2' ? 'selected' : '' }}>Rusak
                                                            </option>
                                                            <option value="3"
                                                                {{ request('aset_kondisi') == '3' ? 'selected' : '' }}>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select class="form-select" aria-label="Select status aset"
                                                            name="aset_status" required>
                                                            <option selected="">Pilih Status Aset</option>
                                                            <option value="1"
                                                                {{ request('aset_status') == '1' ? 'selected' : '' }}>Aktif
                                                            </option>
                                                            <option value="2"
                                                                {{ request('aset_status') == '2' ? 'selected' : '' }}>Tidak
                                                                Aktif</option>
                                                            <option value="3"
                                                                {{ request('aset_status') == '3' ? 'selected' : '' }}>
                                                                Dihapus</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label" for="aset_kategori">Kategori aset</label>
                                                        <select class="form-select" aria-label="Select kategori aset"
                                                            name="aset_kategori" required>
                                                            <option selected="">Pilih Kategori Aset</option>
                                                            <option value="1"
                                                                {{ request('aset_kategori') == '1' ? 'selected' : '' }}>
                                                                Elektronik</option>
                                                            <option value="2"
                                                                {{ request('aset_kategori') == '2' ? 'selected' : '' }}>
                                                                Kendaraan</option>
                                                            <option value="3"
                                                                {{ request('aset_kategori') == '3' ? 'selected' : '' }}>
                                                                Furniture</option>
                                                            <option value="4"
                                                                {{ request('aset_kategori') == '4' ? 'selected' : '' }}>
                                                                lainnya</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <form class="row g-3 app-form rounded-control"
                                                    action="{{ route('uppsfaculty.Asset.store') }}" method="POST">
                                                    @csrf
                                                    <div class="col-md-6">
                                    ...
                                    @foreach ($data['aset'] as $asetData)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('uppsfaculty.Asset.edit', $asetData->id) }}"
                                                    class="btn btn-light-success icon-btn b-r-4">
                                                    <i class="ti ti-edit text-success"></i>
                                                </a>
                                                <form class="btn btn-light-danger icon-btn b-r-4"
                                                    action="{{ route('uppsfaculty.Asset.destroy', $asetData->id) }}"
                                                    method="POST">
                                                    @method('delete')
                                                    @csrf
                                                    <button type="button"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p><i class="ti ti-arrow-big-right text-secondary f-w-600"></i> Harga Perolehan:
                                {{ $constantUser->formatRupiah($asetData->harga_perolehan) }} </p>
