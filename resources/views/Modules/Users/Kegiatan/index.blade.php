        ...
        <div class="row m-1">
            <div class="col-12 ">
                ...
                <ul class="app-line-breadcrumbs mb-3">
                    ...
                    <li class="active">
                        <a href="{{ route('uppsfaculty.Kegiatan.index') }}" class="f-s-14 f-w-500">Data</a>
                    </li>
                </ul>
            </div>
        </div>
                            ...
                            <div class="collapse collapse-horizontal" id="collapseFilter">
                                <div class="card card-body dashed-1-secondary w-900">
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <form action="{{ route('uppsfaculty.Kegiatan.index') }}" method="GET"
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <form class="row g-3 app-form rounded-control"
                                                    action="{{ route('uppsfaculty.Kegiatan.store') }}" method="POST"
                                    ...
                                    @foreach ($data['kegiatan'] as $kegiatan)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('uppsfaculty.Kegiatan.edit', $kegiatan->id) }}"
                                                    class="btn btn-light-success icon-btn b-r-4">
                                                    <i class="ti ti-edit text-success"></i>
                                                </a>
                                                <form class="btn btn-light-danger icon-btn b-r-4"
                                                    action="{{ route('uppsfaculty.Kegiatan.destroy', $kegiatan->id) }}"
                                                    method="POST">
                                                    @method('delete')
                                                    @csrf
                                                    <button type="button"
