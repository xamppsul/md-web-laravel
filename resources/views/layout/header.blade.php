                                ...
                                <div>
                                    <ul class="search-list">
                                        ...
                                        <li class="search-list-item">
                                            ...
                                            <div class="search-list-content">
                                                <a href="{{ __('privacy_policy') }}" target="_blank">
                                        ...
                                        <li class="search-list-item">
                                            ...
                                            <div class="search-list-content">
                                                <a href="{{ __('terms_condition') }}" target="_blank">
                                        ...
                                        <li class="search-list-item">
                                            ...
                                            <div class="search-list-content">
                                                <a href="{{ __('sign_in') }}" target="_blank">
                                        ...
                                        <li class="search-list-item">
                                            ...
                                            <div class="search-list-content">
                                                <a href="{{ __('data_table') }}" target="_blank">
                                ...
                                <div class="app-dropdown flex-shrink-0">
                                    ...
                                    <ul class="dropdown-menu mb-3 p-2">
                                        <li class="dropdown-item">
                                            <a href="{{ __('setting') }}" target="_blank">
                                                Privacy Settings
                                            </a>
                                        </li>
                                        <li class="dropdown-item">
                            ...
                            <div class="offcanvas-body app-scroll">
                                <div class="row row-cols-3">
                                    <div class="d-flex-center text-center mb-3">
                                        <a href="{{ __('product') }}" target="_blank">
                                    ...
                                    <div class="d-flex-center text-center mb-3">
                                        <a href="{{ __('project_app') }}" target="_blank">
                                    ...
                                    <div class="d-flex-center text-center mb-3">
                                        <a href="{{ __('invoice') }}" target="_blank">
                                    ...
                                    <div class="d-flex-center text-center mb-3">
                                        <a href="{{ __('profile') }}" target="_blank">
                                            <span
                                                class="text-light-primary h-45 w-45 d-flex-center b-r-15 position-relative">
                                    ...
                                    <div class="d-flex-center text-center mb-3">
                                        <a href="{{ __('gallery') }}" target="_blank">
                                    ...
                                    <div class="d-flex-center text-center mb-3">
                                        <a href="{{ __('kanban_board') }}" target="_blank">
                                            <span class="text-light-info h-45 w-45 d-flex-center b-r-15">
                                    ...
                                    <div class="d-flex-center text-center mb-3">
                                        <a href="{{ __('calendar') }}" target="_blank">
                                    ...
                                    <div class="d-flex-center text-center mb-3">
                                        <a href="{{ __('file_manager') }}" target="_blank">
                            ...
                            <div class="offcanvas-footer">
                                <div class="head-box-footer p-3">
                                    ...
                                    <div class="header-cart-btn">
                                        <a class="btn btn-light-primary" href=""{{ __('cart') }}"
                                            role="button" target="_blank">
                                            <i class="ti ti-eye"></i> View Cart</a>
                                        <a class="btn btn-light-success" href="{{ __('checkout') }}" role="button"
                                            target="_blank">
                        ...
                        <div aria-labelledby="profilecanvasRight"
                            ...
                            <div class="offcanvas-body app-scroll">
                                <ul class="">
                                    ...
                                    <li>
                                        <a class="f-w-500" href="{{ __('setting') }}" target="_blank">
                                    ...
                                    <li>
                                        <div class="app-dropdown dropstart">
                                            <a aria-expanded="false" class="f-w-500" data-bs-toggle="dropdown"
                                                href="{{ __('setting') }}" role="button" target="_blank">
                                    ...
                                    <li class="app-divider-v dotted py-1"></li>
                                    <li>
                                        <a class="f-w-500" href="{{ __('faq') }}" target="_blank">
                                            <i class="iconoir-help-circle pe-1 f-s-20"></i> Help
                                        </a>
                                    </li>
                                    <li>
                                        <a class="f-w-500" href="{{ __('pricing') }}" target="_blank">
                                            <i class="iconoir-dollar pe-1 f-s-20"></i>
                                            Pricing
                                        </a>
                                    </li>
                                    <li>
                                        <a class="mb-0 text-secondary f-w-500" href="{{ __('sign_up') }}"
                                            target="_blank">
