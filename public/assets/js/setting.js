...
var showPassword1Btn = document.querySelector("#showPassword1");
if (showPassword1Btn) {
  showPassword1Btn.addEventListener("click", () => {
...
var showPassword2Btn = document.querySelector("#showPassword2");
if (showPassword2Btn) {
  showPassword2Btn.addEventListener("click", () => {
