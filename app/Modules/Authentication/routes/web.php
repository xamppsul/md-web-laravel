...
Route::middleware('throttle:30,1')->group(function () {
    ...
    Route::group(['prefix' => 'user', 'middleware' => 'auth:user'], function () {
        Route::prefix('dashboard')->group(function () {
            Route::get('/', [Handler::class, 'viewUserDashboard'])->name('user.view.dashboard');
            Route::post('/profile', [Handler::class, 'updateOrCreateUserProfile'])->name('user.updateOrCreateUserProfile.dashboard');
        });
